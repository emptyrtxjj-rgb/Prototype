      ...
      <div className="bg-white border border-stone-200 rounded-[24px] p-6 sm:p-8 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-2 max-w-3xl">
          ...
          <p className="text-stone-600 text-xs sm:text-sm font-serif leading-relaxed">
            {isKk
              ? 'Smart School KZ платформасына толық көшу нәтижесіндегі нақты үнем: цифрлық оқушы кабинеті, зерттеу жобаларын қағазсыз қорғау және лицейлік табиғи ресурстар аудиті.'
              : 'Реальный аудит сбережения ресурсов благодаря переходу на Smart School KZ: отказ от бумажной отчетности, цифровая защита исследовательских проектов и учет углеродного следа.'}
          </p>
        </div>
