      ...
      <div className="bg-white border border-stone-200 rounded-[24px] p-8 sm:p-12 shadow-sm relative overflow-hidden">
        <div className="space-y-4 max-w-3xl relative z-10">
          ...
          <p className="text-stone-600 text-sm sm:text-base leading-relaxed font-serif">
            {isKk
              ? 'Қазақстанның 7 842 мектебіне арналған бірыңғай мемлекеттік цифрлық білім экожүйесі («eGov мектептері үшін»). Жүйе халықаралық құзыреттер матрицасын, накладкасыз AI сабақ кестесін, эсселерді тексеретін академиялық менторды және қағазсыз мектеп экожүйесін біріктіреді.'
              : 'Единая государственная цифровая экосистема для 7 842 школ Казахстана («eGov для школ Казахстана»). Платформа объединяет международную матрицу компетенций, интеллектуальный планировщик расписания без накладок, академический AI ментор и стандарт безбумажной школы.'}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="academic-card bg-white p-6 space-y-3 border border-stone-200">
            ...
            <h3 className="font-climate text-lg text-stone-900 uppercase">Competency Matrix</h3>
            <p className="text-xs text-stone-600 leading-relaxed font-serif">
              {isKk ? 'Көпвекторлы құзыреттілік бағалау жүйесі (Mastery Framework): теория, қолданбалы есептер, зертханалық жобалар және қорғау арқылы оқушының шынайы потенциалын ашу.' : 'Многовекторная система компетентностного оценивания (Mastery Framework): теория, прикладные задачи, лабораторные проекты и защита, раскрывающие реальный потенциал ученика.'}
            </p>
          </div>
          ...
          <div className="academic-card bg-white p-6 space-y-3 border border-stone-200">
            ...
            <p className="text-xs text-stone-600 leading-relaxed font-serif">
              {isKk ? 'Эвристикалық шектеулер негізінде сабақ кестесін қақтығыссыз құрастыру (Conflict-Free Solver) және академиялық эссе мен ғылыми жұмыстар сапасын талдайтын AI ментор.' : 'Эвристический планировщик расписания без накладок (Conflict-Free Solver) и AI наставник для проверки академических эссе и исследовательских работ.'}
            </p>
          </div>
        </div>
      </div>
